...
insert into delivery(package_id, sender_id, recipient_id, payment_id, send_date, send_from, send_to, price, current_position) values(1, 1, 2, 1, '2023-01-01', 'Kyiv', 'Kharkiv', 2500, 'виїхала');
